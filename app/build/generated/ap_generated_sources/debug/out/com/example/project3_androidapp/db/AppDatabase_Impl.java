  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `UserEntity` (`userId` INTEGER, `username` TEXT, `password` TEXT, `admin` INTEGER, `cardListId` INTEGER, `userListId` INTEGER, `bank` INTEGER, `transactionListId` INTEGER, PRIMARY KEY(`userId`))");
        ...
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, 'da84283567bd17c5efd57a24a3a3e088')");
      }
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        _columnsUserEntity.put("bank", new TableInfo.Column("bank", "INTEGER", false, 0, null, TableInfo.CREATED_FROM_ENTITY));
    ...
    }, "da84283567bd17c5efd57a24a3a3e088", "ad443d2b7b8115184a01a50307665d72");
