  ...
  public UserEntity getUserById(final int userId) {
    ...
    try {
      ...
      if(_cursor.moveToFirst()) {
        ...
        _result.setUserListId(_tmpUserListId);
        final Integer _tmpBank;
        if (_cursor.isNull(_cursorIndexOfBank)) {
          _tmpBank = null;
        } else {
          _tmpBank = _cursor.getInt(_cursorIndexOfBank);
        }
  ...
  public List<UserEntity> getAllUsers() {
    ...
    try {
      ...
      while(_cursor.moveToNext()) {
        ...
        _item.setUserListId(_tmpUserListId);
        final Integer _tmpBank;
        if (_cursor.isNull(_cursorIndexOfBank)) {
          _tmpBank = null;
        } else {
