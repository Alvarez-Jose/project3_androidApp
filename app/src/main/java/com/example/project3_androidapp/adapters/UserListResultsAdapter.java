...
public class UserListResultsAdapter extends RecyclerView.Adapter<UserListResultsAdapter.SearchResultHolder> {
    ...
    public UserListResultsAdapter(Context context) {
        this.context = context;
    }

    public UserListResultsAdapter() {
