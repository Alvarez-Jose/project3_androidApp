...
public class CardResultsAdapter extends RecyclerView.Adapter<CardResultsAdapter.SearchResultHolder> {
    ...
    public CardResultsAdapter(Context context) {
        this.context = context;
    }

    public CardResultsAdapter() {
